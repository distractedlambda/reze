...
pub const Instr = union(enum) {
    ...
    @"f32x4.splat": void,
    @"f64x2.splat": void,
    @"i8x16.extract_lane_s": u4,
    @"i8x16.extract_lane_u": u4,
    @"i8x16.replace_lane": u4,
    @"i16x8.extract_lane_s": u3,
    @"i16x8.extract_lane_u": u3,
    @"i16x8.replace_lane": u3,
    @"i32x4.extract_lane": u2,
    @"i32x4.replace_lane": u2,
    @"i64x2.extract_lane": u1,
    @"i64x2.replace_lane": u1,
    @"f32x4.extract_lane": u2,
    @"f32x4.replace_lane": u2,
    @"f64x2.extract_lane": u1,
    @"f64x2.replace_lane": u1,
    @"i8x16.eq": void,
    @"i8x16.ne": void,
    @"i8x16.lt_s": void,
    @"i8x16.lt_u": void,
    ...
    @"v128.bitselect": void,
    @"v128.any_true": void,
    @"v128.load8_lane": struct { MemArg, u4 },
    @"v128.load16_lane": struct { MemArg, u3 },
    @"v128.load32_lane": struct { MemArg, u2 },
    @"v128.load64_lane": struct { MemArg, u1 },
    @"v128.store8_lane": struct { MemArg, u4 },
    @"v128.store16_lane": struct { MemArg, u3 },
    @"v128.store32_lane": struct { MemArg, u2 },
    @"v128.store64_lane": struct { MemArg, u1 },
