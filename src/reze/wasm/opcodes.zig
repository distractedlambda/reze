...
pub fn shortOpcodeName(opcode: u8) ?[:0]const u8 {
...
pub fn longOpcodeName(opcode: u32) ?[:0]const u8 {
    return switch (opcode) {
...
pub fn simdOpcodeName(opcode: u32) ?[:0]const u8 {
    return switch (opcode) {
        @"v128.load" => "v128.load",
        @"v128.load8x8_s" => "v128.load8x8_s",
        @"v128.load8x8_u" => "v128.load8x8_u",
        @"v128.load16x4_s" => "v128.load16x4_s",
        @"v128.load16x4_u" => "v128.load16x4_u",
        @"v128.load32x2_s" => "v128.load32x2_s",
        @"v128.load32x2_u" => "v128.load32x2_u",
        @"v128.load8_splat" => "v128.load8_splat",
        @"v128.load16_splat" => "v128.load16_splat",
        @"v128.load32_splat" => "v128.load32_splat",
        @"v128.load64_splat" => "v128.load64_splat",
        @"v128.store" => "v128.store",
        @"v128.const" => "v128.const",
        @"i8x16.shuffle" => "i8x16.shuffle",
        ...
        @"i8x16.extract_lane_u" => "i8x16.extract_lane_u",
        @"i8x16.replace_lane" => "i8x16.replace_lane",
        @"i16x8.extract_lane_s" => "i16x8.extract_lane_s",
        @"i16x8.extract_lane_u" => "i16x8.extract_lane_u",
        @"i16x8.replace_lane" => "i16x8.replace_lane",
        @"i32x4.extract_lane" => "i32x4.extract_lane",
        @"i32x4.replace_lane" => "i32x4.replace_lane",
        @"i64x2.extract_lane" => "i64x2.extract_lane",
        @"i64x2.replace_lane" => "i64x2.replace_lane",
        @"f32x4.extract_lane" => "f32x4.extract_lane",
        @"f32x4.replace_lane" => "f32x4.replace_lane",
        @"f64x2.extract_lane" => "f64x2.extract_lane",
        @"f64x2.replace_lane" => "f64x2.replace_lane",
        @"i8x16.eq" => "i8x16.eq",
        @"i8x16.ne" => "i8x16.ne",
        ...
        @"v128.load8_lane" => "v128.load8_lane",
        @"v128.load16_lane" => "v128.load16_lane",
        @"v128.load32_lane" => "v128.load32_lane",
        @"v128.load64_lane" => "v128.load64_lane",
        @"v128.store8_lane" => "v128.store8_lane",
        @"v128.store16_lane" => "v128.store16_lane",
        @"v128.store32_lane" => "v128.store32_lane",
        @"v128.store64_lane" => "v128.store64_lane",
        @"v128.load32_zero" => "v128.load32_zero",
        @"v128.load64_zero" => "v128.load64_zero",
        ...
        @"i16x8.dot_i8x16_i7x16_s" => "i16x8.dot_i8x16_i7x16_s",
        @"i32x4.dot_i8x16_i7x16_add_s" => "i32x4.dot_i8x16_i7x16_add_s",
        else => null,
    };
}
...
pub fn threadOpcodeName(opcode: u32) ?[:0]const u8 {
    return switch (opcode) {
        @"memory.atomic.notify" => "memory.atomic.notify",
        @"memory.atomic.wait32" => "memory.atomic.wait32",
        @"memory.atomic.wait64" => "memory.atomic.wait64",
        @"atomic.fence" => "atomic.fence",
        @"i32.atomic.load" => "i32.atomic.load",
        @"i64.atomic.load" => "i64.atomic.load",
        @"i32.atomic.load8_u" => "i32.atomic.load8_u",
        @"i32.atomic.load16_u" => "i32.atomic.load16_u",
        @"i64.atomic.load8_u" => "i64.atomic.load8_u",
        @"i64.atomic.load16_u" => "i64.atomic.load16_u",
        @"i64.atomic.load32_u" => "i64.atomic.load32_u",
        @"i32.atomic.store" => "i32.atomic.store",
        @"i64.atomic.store" => "i64.atomic.store",
        @"i32.atomic.store8" => "i32.atomic.store8",
        @"i32.atomic.store16" => "i32.atomic.store16",
        @"i64.atomic.store8" => "i64.atomic.store8",
        @"i64.atomic.store16" => "i64.atomic.store16",
        @"i64.atomic.store32" => "i64.atomic.store32",
        @"i32.atomic.rmw.add" => "i32.atomic.rmw.add",
        @"i64.atomic.rmw.add" => "i64.atomic.rmw.add",
        @"i32.atomic.rmw8.add_u" => "i32.atomic.rmw8.add_u",
        @"i32.atomic.rmw16.add_u" => "i32.atomic.rmw16.add_u",
        @"i64.atomic.rmw8.add_u" => "i64.atomic.rmw8.add_u",
        @"i64.atomic.rmw16.add_u" => "i64.atomic.rmw16.add_u",
        @"i64.atomic.rmw32.add_u" => "i64.atomic.rmw32.add_u",
        @"i32.atomic.rmw.sub" => "i32.atomic.rmw.sub",
        @"i64.atomic.rmw.sub" => "i64.atomic.rmw.sub",
        @"i32.atomic.rmw8.sub_u" => "i32.atomic.rmw8.sub_u",
        @"i32.atomic.rmw16.sub_u" => "i32.atomic.rmw16.sub_u",
        @"i64.atomic.rmw8.sub_u" => "i64.atomic.rmw8.sub_u",
        @"i64.atomic.rmw16.sub_u" => "i64.atomic.rmw16.sub_u",
        @"i64.atomic.rmw32.sub_u" => "i64.atomic.rmw32.sub_u",
        @"i32.atomic.rmw.and" => "i32.atomic.rmw.and",
        @"i64.atomic.rmw.and" => "i64.atomic.rmw.and",
        @"i32.atomic.rmw8.and_u" => "i32.atomic.rmw8.and_u",
        @"i32.atomic.rmw16.and_u" => "i32.atomic.rmw16.and_u",
        @"i64.atomic.rmw8.and_u" => "i64.atomic.rmw8.and_u",
        @"i64.atomic.rmw16.and_u" => "i64.atomic.rmw16.and_u",
        @"i64.atomic.rmw32.and_u" => "i64.atomic.rmw32.and_u",
        @"i32.atomic.rmw.or" => "i32.atomic.rmw.or",
        @"i64.atomic.rmw.or" => "i64.atomic.rmw.or",
        @"i32.atomic.rmw8.or_u" => "i32.atomic.rmw8.or_u",
        @"i32.atomic.rmw16.or_u" => "i32.atomic.rmw16.or_u",
        @"i64.atomic.rmw8.or_u" => "i64.atomic.rmw8.or_u",
        @"i64.atomic.rmw16.or_u" => "i64.atomic.rmw16.or_u",
        @"i64.atomic.rmw32.or_u" => "i64.atomic.rmw32.or_u",
        @"i32.atomic.rmw.xor" => "i32.atomic.rmw.xor",
        @"i64.atomic.rmw.xor" => "i64.atomic.rmw.xor",
        @"i32.atomic.rmw8.xor_u" => "i32.atomic.rmw8.xor_u",
        @"i32.atomic.rmw16.xor_u" => "i32.atomic.rmw16.xor_u",
        @"i64.atomic.rmw8.xor_u" => "i64.atomic.rmw8.xor_u",
        @"i64.atomic.rmw16.xor_u" => "i64.atomic.rmw16.xor_u",
        @"i64.atomic.rmw32.xor_u" => "i64.atomic.rmw32.xor_u",
        @"i32.atomic.rmw.xchg" => "i32.atomic.rmw.xchg",
        @"i64.atomic.rmw.xchg" => "i64.atomic.rmw.xchg",
        @"i32.atomic.rmw8.xchg_u" => "i32.atomic.rmw8.xchg_u",
        @"i32.atomic.rmw16.xchg_u" => "i32.atomic.rmw16.xchg_u",
        @"i64.atomic.rmw8.xchg_u" => "i64.atomic.rmw8.xchg_u",
        @"i64.atomic.rmw16.xchg_u" => "i64.atomic.rmw16.xchg_u",
        @"i64.atomic.rmw32.xchg_u" => "i64.atomic.rmw32.xchg_u",
        @"i32.atomic.rmw.cmpxchg" => "i32.atomic.rmw.cmpxchg",
        @"i64.atomic.rmw.cmpxchg" => "i64.atomic.rmw.cmpxchg",
        @"i32.atomic.rmw8.cmpxchg_u" => "i32.atomic.rmw8.cmpxchg_u",
        @"i32.atomic.rmw16.cmpxchg_u" => "i32.atomic.rmw16.cmpxchg_u",
        @"i64.atomic.rmw8.cmpxchg_u" => "i64.atomic.rmw8.cmpxchg_u",
        @"i64.atomic.rmw16.cmpxchg_u" => "i64.atomic.rmw16.cmpxchg_u",
        @"i64.atomic.rmw32.cmpxchg_u" => "i64.atomic.rmw32.cmpxchg_u",
        else => null,
    };
}
